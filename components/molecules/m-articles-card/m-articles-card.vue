<template>
  <nuxt-link
    :to="{ path: `/blog/articles/${articles.slug}`, query: { id: articles.id } }"
    class="m-articles-card"
    :class="{ main: isMainPage, comp: isComp }"
  >
    <div class="m-articles-card__tags">
      <div class="m-articles-card__tags-tag f-text-xxs">
