      ...
      <form class="s-form" @submit.prevent="onSubmit">
        <div class="s-form__wrapper">
          <div class="s-form__content">
            ...
            <div>
              <span class="f-text-m f-link cursor-pointer" @click="change">Изменить</span>
            </div>
            <div class="s-form__items mbt8 t-left">
...
const emit = defineEmits(['openAuth', 'close', 'openRegChange']);
...
const subtitle = computed(() => {
  return `Мы отправили письмо на вашу электронную почту. Перейдите по ссылке в письме, чтобы активировать ваш аккаунт.`;
});
