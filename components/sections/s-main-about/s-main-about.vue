<template>
  <section class="s-main-about section-l">
    <div class="s-main-about__wrapper">
      <div class="s-main-about__inner">
        <div class="container">
          <h1 class="s-main__title" :aria-lsabel="title">
            <img src="/img/about-page/title.svg" loading="lazy" :alt="title" />
    ...
    <div class="container">
      <p class="s-main-about__desc desc">
        — это сайт-навигатор для абитуриентов, что ищут учереждения среднего профессионального образования для
        поступления. Проект будет полезен как для абитуриентов, так и для их родителей.
      </p>
      <div class="s-main-about__box">
        <nuxt-link to="/applicants" class="s-main-about__box-item">
          <span class="title-h3 white">Для абитуриента</span>
          <a-button
            class="s-main-about__box-button"
            :label="'Подробнее'"
            color="white"
            textSize="f-text-m"
            :img="arrow"
        ...
        <nuxt-link to="/parents" class="s-main-about__box-item">
          <span class="title-h3 white">Для родителя</span>
          <a-button
            class="s-main-about__box-button"
            :label="'Подробнее'"
            color="white"
