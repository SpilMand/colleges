<template>
  <section id="" class="s-now-read-news section-m swiper-default">
    ...
    <div class="s-now-read-news__box">
      ...
      <div class="s-now-read-news-swiper-navigation s-swiper-navigation">
...
const swiperConfig = reactive({
  ...
  pagination: {
    el: '.s-now-read-news-swiper-pagination',
    clickable: true,
  },
