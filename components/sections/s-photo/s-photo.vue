<template>
  <section v-if="photos[1]" id="" class="s-photo section-m swiper-default">
    <h3 class="s-photo__title title-h3">Фото колледжа</h3>
    <div class="s-photo__box">
      <swiper v-bind="swiperConfig" class="mySwiper">
        <swiper-slide v-for="(photo, index) in photos" :key="index">
          <img
            v-if="photo.attributes.title != 'logo'"
            class="s-photo__slide"
      ...
      <div class="s-photo-swiper-pagination s-swiper-pagination"></div>
      <div class="s-photo-swiper-navigation s-swiper-navigation">
