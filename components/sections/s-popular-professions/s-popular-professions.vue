<template>
  <section id="" class="s-popular-professions section-l swiper-default">
    ...
    <div class="s-popular-professions__box">
      ...
      <div class="s-popular-professions-swiper-pagination s-swiper-pagination"></div>
      <div class="s-popular-professions-swiper-navigation s-swiper-navigation">
...
const swiperConfig = reactive({
  ...
  pagination: {
    el: '.s-popular-professions-swiper-pagination',
    clickable: true,
  },
...
<style lang="scss">
@import './s-popular-professions.scss';
</style>
