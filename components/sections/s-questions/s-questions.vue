<template>
  <section class="s-questions section-m">
    <h3 class="title-h3">Вопросы абитуриентов о колледже</h3>
    <div class="s-questions__content">
      <NuxtLink
        v-for="(question, index) in questions"
        :key="index"
        to="/colleges/id/questions"
        class="s-questions__question f-text-m"
        :test-id="`link-s-questions-${index}`"
      >
        {{ question }}
