  ...
  <section v-if="reviews.data" class="s-reviews section-l swiper-default f-fade">
    <div class="container">
      ...
      <div class="s-reviews__box">
        <div class="s-reviews__wrapper right-border-carousel">
          <swiper v-bind="swiperConfig" class="mySwiper">
            <swiper-slide v-for="(review, index) in reviews" :key="index">
              <m-reviews-card :reviews="review" />
            </swiper-slide>
          </swiper>
        </div>
        <div class="s-reviews-swiper-pagination s-swiper-pagination"></div>
        <div class="s-reviews-swiper-navigation s-swiper-navigation">
...
async function fetchData() {
  ...
  reviews.value = dataFormatter.deserialize(reviews.value);
}
