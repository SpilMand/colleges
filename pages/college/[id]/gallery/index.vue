<template>
  <div class="gallery">
    ...
    <h4 v-else class="title-h4 gray section-m">Скоро здесь появятся фотографии колледжа</h4>
    <!-- <a-pagination
    ...
    <m-popup :visible="isPopup" class="gallery__popup" @close="isPopup = false">
      <div class="gallery__popup-inner swiper-default">
        ...
        <swiper v-bind="swiperConfig" class="mySwiper" @swiper="setSwiper">
          <swiper-slide v-for="(photo, index) in photos" :key="index">
            <div class="gallery__photo-swiper">
              <img :src="photo.attributes.url" alt="" />
            </div>
          </swiper-slide>
        </swiper>
        ...
        <div class="gallery__popup-pagination s-swiper-pagination"></div>
      </div>
    </m-popup>
  </div>
</template>
...
const openPhoto = (index) => {
  mySwiper.value.activeIndex = index;
